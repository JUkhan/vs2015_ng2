    ...
    private initGrid() {
        this.gridOptions = {
            ...
            columnDefs: [
                ...
                { headerName: 'Education', filter:'set', sort:true, change:this.changeEducation.bind(this), validators:FV.required, field: 'education',type:'juSelect', width:160},
                ...
                { headerName: 'Address', viewMode:'select', search:true,  field: 'address', type:'juSelect', width:170, validators:FV.required },
